export const siteConfig = {
  ...
  phone: process.env.NEXT_PUBLIC_SITE_PHONE || '010-7980-5207',
  phoneRaw: (process.env.NEXT_PUBLIC_SITE_PHONE || '010-7980-5207').replace(/[^0-9+]/g, ''),
  phoneTel: (process.env.NEXT_PUBLIC_SITE_PHONE || '010-7980-5207').startsWith('010') 
    ? '+82-10-' + (process.env.NEXT_PUBLIC_SITE_PHONE || '010-7980-5207').replace(/^010-?/, '')
    : process.env.NEXT_PUBLIC_SITE_PHONE || '+82-10-7980-5207',
